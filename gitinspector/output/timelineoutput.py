    ...
    for name in names:
        if timeline_data.is_author_in_periods(periods, name[0]):
            ...
            for period in periods:
                ...
                print(("." if timeline_data.is_author_in_period(period, name[0]) and len(signs_str) == 0
                       else signs_str).rjust(10), end=" ")
            print("")
    ...
    for name in names:
        if timeline_data.is_author_in_periods(periods, name[0]):
            ...
            for period in periods:
                ...
                signs = timeline_data.get_author_signs_in_period(name[0], period, multiplier)
                signs_str = (signs[1] * "<div class=\"remove\">&nbsp;</div>" + signs[
                    0] * "<div class=\"insert\">&nbsp;</div>")
